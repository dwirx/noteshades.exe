...
echo.
echo Linking...
gcc src/main.o src/file_ops.o src/edit_ops.o src/dialogs.o src/line_numbers.o src/notepad.o -o xnote.exe -mwindows -lcomctl32 -lcomdlg32 -s
if errorlevel 1 goto error
